...
local Window = WindUI:CreateWindow({
	Title = "Sally Hub | Rewrite",
	Author = "By Thanh Dat - https://discord.gg/BxU2jvFjx7",
	Folder = "SallyHub",
	...
	Buttons = {
		{
			Title = "Copy Link",
			Callback = function()
				setclipboard("https://discord.gg/BxU2jvFjx7");
				WindUI:Notify({
					Title = "Notification",
					Content = "Copied",
					Icon = "bell",
	...
	pcall(function()
		while wait(0.2) do
			if World3 then
				...
				KitsuneStatusParagraph:SetDesc("Sea 3 Only");
			end;
		end;
	end);
end);
	...
	pcall(function()
		while wait(0.2) do
			if World3 then
				...
				PrehistoricStatusParagraph:SetDesc("Sea 3 Only");
			end;
		end;
	end);
end);
	...
	pcall(function()
		while wait(0.2) do
			if World2 or World3 then
				...
				MirageStatusParagraph:SetDesc("Sea 3 Only");
			end;
		end;
	end);
end);
